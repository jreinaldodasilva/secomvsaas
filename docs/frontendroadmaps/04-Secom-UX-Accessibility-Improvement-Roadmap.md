...
|----------|--------|-----------------|----------|
| WCAG contrast compliance | P0-3, P0-4, P1-3, P1-4, P1-5 | 3 days | Critical compliance debt |
| Focus management & keyboard traps | P0-2 | 0.5 days | Critical compliance debt |
| Skip navigation / landmarks | P0-5 | 0.5 hours | Critical compliance debt |
| Semantic HTML corrections | P2-2, P1-7 | 1 day | Structural UX debt |
| ARIA implementation gaps | P1-6, P2-6, P2-7, P3-5 | 1 day | ARIA implementation debt |
| Screen reader optimization | P1-6, P2-7, P1-7 | 1 day | Screen reader debt |
...
| UX consistency (design system) | P1-1, P2-5, P2-8, P2-9, P3-1 | 3 days | Design system accessibility gap |
| Mobile layout | P0-1, P1-9, P2-3 | 4 days | Structural UX debt |
| Feedback & empty states | P2-1, P2-14 | 1.5 days | UX consistency debt |
| i18n / microcopy | P2-10 | 0.5 hours | UX consistency debt |

### 2.2 Total Effort Summary

| Debt Class | Effort |
|-----------|--------|
| Critical compliance debt (P0) | ~5 days |
| High-priority UX debt (P1) | ~5 days |
| Medium improvements (P2) | ~8 days |
| Low refinements (P3) | ~3 days |
| **Total** | **~21 days (~4.5 weeks, 1 developer)** |
...
- P0-2: No focus trap on `SessionTimeoutModal` (WCAG 2.1.2, 2.4.3)
- P0-3, P0-4: Sidebar contrast failures (WCAG 1.4.3)
- P0-5: Skip link non-functional on citizen portal (WCAG 2.4.1)
- P1-3, P1-4, P1-5: Additional contrast failures (WCAG 1.4.3)
- P1-7: Missing programmatic label association (WCAG 1.3.1)
...
- Zero WCAG 1.4.3 contrast failures on interactive/informational elements
- `SessionTimeoutModal` passes keyboard trap test
...
|--------|--------------|--------|
| WCAG 2.1 AA compliance | Partial — 6 contrast failures, 2 focus management violations, 3 semantic violations | Part 2, §4.1–4.2 |
| Contrast failures (interactive/informational) | 6 elements failing | Part 2, §4.1 |
| Keyboard navigation completeness | ~85% — DataTable, Modal, skip link all work; SessionTimeoutModal broken | Part 2, §4.3 |
| Screen reader landmark coverage | ~90% — all major landmarks present; citizen portal skip link broken | Part 2, §5.1 |
...
| Design system token adherence | ~80% — raw hex in dashboard, `!important` in landing, legacy aliases in 2 files | Part 1, §2.2 |
| Empty state quality | Low — text-only, no icon, no CTA on all domain pages | Part 2, §7.4 |
| Estimated Lighthouse Accessibility score | ~72–78 (estimated from documented violations) | Part 2, §4.1–4.2 |
...
|-----------|-------|--------|
| UX Health | 62 / 100 | 🟧 Needs Improvement |
| Accessibility Compliance | 58 / 100 | 🟧 Needs Improvement |
| Mobile Usability | 45 / 100 | 🟥 Poor |
| Design System Consistency | 78 / 100 | 🟨 Fair |
| Interaction Quality | 80 / 100 | 🟨 Good |
| Feedback & Loading States | 74 / 100 | 🟨 Fair |

**Scoring basis:** Derived from the ratio of passing to failing items in each category as documented in the audit. Mobile usability is scored low due to the critical sidebar breakpoint failure affecting all 10 dashboard pages.
...
|-------|---------|--------|---------|
| Critical compliance | Sprint 1 (Weeks 1–2) | ~9 days | Zero WCAG violations; mobile dashboard unblocked |
| High-priority UX | Sprint 2 (Weeks 3–4) | ~7 days | Consistent design system; reduced motion compliant; touch targets fixed |
| Consistency & enhancement | Sprint 3 (Weeks 5–6) | ~5 days | Token hygiene; empty states; heading hierarchy |
| Polish & refinements | Sprint 4 (Weeks 7–8) | ~3 days | Mobile performance; remaining low-priority items |
| **Total** | **4 sprints** | **~24 days** | **Full WCAG 2.1 AA compliance; Lighthouse ≥95** |
